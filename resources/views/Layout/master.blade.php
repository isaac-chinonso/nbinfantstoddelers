...
<head>
        ...
        <meta name="description" content="online baby store">
        <meta name="author" content="Nbinfants&toddlers">
        <meta name="keywords" content="infants & toddlers">
                        ...
                        <div class="row space-top-35">
                            <aside class="col-md-3 col-sm-6">
                                <div class="footer-widget space-bottom-35">
                                    ...
                                    <p class="textwidget"> NB Infants & Kiddies Online Store.  </p>
                                    <div class="address">
                                        <ul>
                                            <li> <i class="fa fa-phone blue-color"></i> <span> 07946301282 </span> </li>
                                            <li> <i class="fa fa-envelope blue-color"></i> <a href="mailto:baby.kidsstore@example.com"> <span> nb.infant&kiddies@gmail.com </span> </a></li>
                                            <li> <i class="fa fa-map-marker blue-color"></i> <span>121 charmont road </span> <span>Tooting broadway Sw17 9ab</span> </li>                                       
                                        </ul>
                                    </div>
                    ...
                    <div class="container theme-container">
                        <div class="row">
                            <aside class="col-md-6 col-sm-6 copy-rights">
                                <P> © Copyright 2018 by <a href="#" class="blue-color"> NB Infants&amp;toddlers.co.uk </a> -  Made By <span class="green-color"> cPod. </span></P>
                            </aside>
